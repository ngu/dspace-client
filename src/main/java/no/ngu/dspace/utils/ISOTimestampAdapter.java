 ...
 *
 * Original code from https://github.com/ngu/geonorge-nedlastingapi/blob/master/src/main/java/no/geonorge/nedlasting/utils/ISOTimestampAdapter.java
 */
public class ISOTimestampAdapter {
